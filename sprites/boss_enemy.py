...
class BossEnemy(BaseEnemy):
    def __init__(self, enemy_type, sprites, player_rect, center, x_velocity, y_velocity, number_of_images, scaled_width,
                 scaled_height):
        super(BossEnemy, self).__init__(enemy_type, sprites, player_rect, center, x_velocity, y_velocity, number_of_images,
                                        scaled_width, scaled_height)

        self.screen_trips = 0
        self.max_screen_trips = 4
        self.max_hits = 3
        self.hits = 0
        self.missile_velocity = 400
        self.points = 25
        self.join()
